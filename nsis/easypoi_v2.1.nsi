...
; 安装程序初始定义常量
!define PRODUCT_NAME "百度地图POI采集程序EasyPoi"
!define PRODUCT_VERSION "2.1"
!define PRODUCT_PUBLISHER "夜雨微寒"
...
!define MUI_STARTMENUPAGE_DEFAULTFOLDER "百度地图POI采集程序EasyPoi"
...
OutFile "EasyPoi_v2.1_Win64.exe"
InstallDir "$PROGRAMFILES\百度地图POI采集程序EasyPoi"
...
; 创建开始菜单快捷方式
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\百度地图POI采集程序EasyPoi.lnk" "$INSTDIR\easypoi.exe"
  CreateShortCut "$DESKTOP\百度地图POI采集程序EasyPoi.lnk" "$INSTDIR\easypoi.exe"
...
Section Uninstall
  ...
  Delete "$DESKTOP\百度地图POI采集程序EasyPoi.lnk"
  Delete "$SMPROGRAMS\$ICONS_GROUP\百度地图POI采集程序EasyPoi.lnk"
